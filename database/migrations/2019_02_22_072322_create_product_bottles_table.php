...
class CreateProductBottlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_bottle', function (Blueprint $table) {
            ...
            $table->string('collar_material')->nullable();
            $table->string('actuator_material')->nullable();
    ...
    {
        Schema::dropIfExists('product_bottle');
    }
}
