...
class ProductAttributeController extends Controller
{
    ...
    public function index($cateId, AdminContent $content)
    {
        return $content
    ...
    {
        return $content
            ->header('Product Attribute Edit')
            ->body($this->form()->edit($id));
    }

    public function create($cateId, AdminContent $content)
    {
        return $content
            ->header('Product Attribute Create')
            ->body($this->form());
    }
    ...
    {
        return $content
            ->header('Product Attribute Detail')
            ->description(' ')
            ->row($this->detail($id));
    }
